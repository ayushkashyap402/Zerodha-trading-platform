    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        ...
        <div className="text-center mb-2">
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>NSE</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>BSE</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>MCX</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>Terms & condition</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>Policies & procedures</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>Privacy policy</a>
            <a href="" className="mx-5 text-muted" style={{textDecoration:"none"}}>Disclosure</a>
        </div>
      </div>
    </footer>
  );
